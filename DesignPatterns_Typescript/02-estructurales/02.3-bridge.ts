...
function main() {
  ...
  alertNotification.notify('¡Este es un mensaje de alerta!');

  const reminderNotification = new ReminderNotification([new PushNotificationChannel()]);
  reminderNotification.notify('¡Este es un recordatorio!');
